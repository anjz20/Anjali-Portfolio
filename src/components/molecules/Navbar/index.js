  ...
  return (
    ...
    >
      <div className="w-full flex items-center justify-between px-3 md:px-24 py-3">
        <div>
          <Link to="/">
            <h1 className="text-2xl text-primary font-lobster">Anjali Sharma</h1>
          </Link>
        </div>
        <div>
            ...
            >
              <ul className="">
                ...
                <li className="text-center m-4">
                  <a
                    ...
                    href="https://drive.google.com/file/d/1QJBzODF5EzZI5yiTRQQDG-ToE9VDX-DW/view?usp=sharing"
                    target="blank"
                  >
              ...
              <div className="text-center">
                <p className="text-neutral">
                  &copy; Copyright 2024, Anjali Sharma. All Rights Reserved
                </p>
              </div>
            </Drawer>
          </div>
