      ...
      <div className="parent py-12">
        ...
        >
          <div className="mt-6 mb-2 flex items-center justify-center flex-wrap">
            ...
            <button
              className={`btn btn-sm bg-primary border-2 border-primary text-white hover:bg-transparent hover:border-primary duration-300 mx-3 my-3 sm:my-0 ${activeBtn === "fullstack" && "active-btn"
                }`}
              onClick={() => {
                setActiveBtn("fullstack");
                filterItem("fullstack");
              }}
            >
              Fullstack
            </button>
            <button
              className={`btn btn-sm bg-primary border-2 border-primary text-white hover:bg-transparent hover:border-primary duration-300 mx-3 my-3 sm:my-0 ${activeBtn === "frontend" && "active-btn"
                }`}
              onClick={() => {
            ...
            onClick={() => {
              setActiveBtn("opensource");
              filterItem("opensource");
            }}
          >
            Opensource
          </button> */}
